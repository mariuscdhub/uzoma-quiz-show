...
description: Generates high-quality, predictable, and efficient skills for the agent environment. Use when the user asks to create a new skill or defines a new persistent capability.
---

# Antigravity Skill Creator

## When to use this skill
- Creating a new skill or agent ability from scratch.
- Defining a new persistent process or workflow for the agent.
- Standardizing a repetative task into a formal skill.

## Workflow
1.  Verify the purpose and scope of the skill.
2.  Determine the skill name (gerund-form, lowercase, hyphens).
3.  Draft the `SKILL.md` content following the mandatory structure and frontmatter rules.
4.  Create the directory structure `.agent/skills/[skill-name]/`.
5.  Write the `SKILL.md` file and any supporting files.
...
### 5. Output Template
When creating a skill, structure the files as follows:
...
(If applicable, provide content for scripts/ or examples/ in separate files)
