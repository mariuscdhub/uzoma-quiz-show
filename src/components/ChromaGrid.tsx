  ...
  const demo: ChromaItem[] = [
    {
      ...
      title: 'Uzoma Show',
      subtitle: 'The Ultimate Trivia',
      handle: '#Uzoma',
      borderColor: '#fbbf24',
      gradient: 'linear-gradient(145deg, #1e3a8a, #0f172a)',
    },
    {
      image: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&q=80&w=300',
      title: 'Jackpot',
      subtitle: 'Mega Prize Pool',
      handle: '#Winner',
      borderColor: '#16a34a',
    ...
    },
    {
      ...
      title: 'Mystery',
      subtitle: 'Hidden Rewards',
      handle: '#Secret',
      borderColor: '#ef4444',
      gradient: 'linear-gradient(165deg, #b91c1c, #000)',
    }
  ];
